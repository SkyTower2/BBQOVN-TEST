package com.me.ml.webview.fragment
...
import com.me.ml.webview.implement.loading.HorizontalProgressBarLoadingConfigImpl
...
import com.me.ml.webview.manager.WebViewHandle
...
open class WebViewFragment : Fragment() {
    ...
    private fun addLoadingView(frameLayout: FrameLayout) {
        ...
        mWebViewHandle = WebViewHandle(
            mWebView,
            mH5UtilsParams.mHandleUrlParamsCallback,
            mWebView?.getWebViewParams()?.mHandleUrlParamsCallback
        )
