...
import static com.me.ml.bluetooth_kit.Constants.*;
...
public class CharacterActivity extends Activity implements View.OnClickListener {
    ...
    private final BleConnectStatusListener mConnectStatusListener = new BleConnectStatusListener() {
        ...
        public void onConnectStatusChanged(String mac, int status) {
            KLog.v(String.format(Locale.US, "CharacterActivity.onConnectStatusChanged status = %d", status));
